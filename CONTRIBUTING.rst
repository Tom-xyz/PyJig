...
Welcome to ``PyJig`` contributor's guide.
...
If you experience bugs or general issues with ``PyJig``, please have a look
...
You can help improve ``PyJig`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``PyJig`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``PyJig``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n PyJig python=3 six virtualenv pytest pytest-cov
    conda activate PyJig
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/PyJig.git
    cd PyJig
...
#. Install |pre-commit|_::
   ...
   ``PyJig`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/PyJig
.. _issue tracker: https://github.com/<USERNAME>/PyJig/issues
.. <-- end -->
